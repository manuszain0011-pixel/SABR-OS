    ...
    return (
        <div className="min-h-screen bg-background p-6">
            <div className="max-w-7xl mx-auto space-y-6">
                ...
                >
                    <h2 className="text-xl font-bold text-foreground mb-6">Year at a Glance</h2>
                    ...
                    <div className="flex items-center justify-center gap-6 mt-8 pt-6 border-t border-border">
                        ...
                        <div className="flex gap-1">
                            ...
                            <div className="w-4 h-4 rounded-sm bg-red-500 opacity-30" />
                            <div className="w-4 h-4 rounded-sm bg-orange-500 opacity-50" />
